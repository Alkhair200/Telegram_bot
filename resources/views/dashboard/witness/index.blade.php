                ...
                <div class="box-header">
                    ...
                    <form action="{{ route('customers.index') }}" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            @if (auth()->user()->hasPermission('witness_create'))
                        ...
                        <tbody>
                            @foreach ($witness as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->command }}</td>
                                    <td>
                                        @if (auth()->user()->hasPermission('witness_edit'))
                                            <a href="{{ route('witness.edit', $item->id) }}"
                                        ...
                                        @if (auth()->user()->hasPermission('witness_delete'))
                                        ...
                                        @else
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-danger delete btn-sm disabled"><i
                                                    class="fa fa-trash"></i>@lang('site.delete')</button>
                                        </div>
                                        @endif
